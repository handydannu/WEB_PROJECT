            ...
            <div class="scroll">
                <div class="scrollContainer">
                    ...
                    <div class="panel" id="contactus">
						...
						<table border="1">
							...
							?>
								<tr>
									...
									<td align="center">
										<a href="riwayat_edit.php?id=<?php echo $data['id_riwayat'] ?>">edit</a>
										<a href="riwayat_hapus.php?id=<?php echo $data['id_riwayat'] ?>" onclick="return confirm('Anda yakin akan menghapus data?')">hapus</a>
									</td>
								</tr>
							<?php
							endforeach;
						...
						<br/>
						<center><h4><a href="dokter_pasien.php">Kembali</a></h4>
						<h4><a href="riwayat_input.php">Input Histori Penyakit</a></h4></center>
