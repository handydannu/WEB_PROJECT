                ...
                <div id="templatemo_header_bottom">
                	<div id="templatemo_menu">
                    	<ul>
                            ...
                            <li class="current"><a href="admin_cari.php"><b>Cari Pasien</b></a></li>
            ...
            <div id="templatemo_content">
            	<div id="templatemo_content_left">
					...
					<style>
						...
						<form action="admin_hasilcari.php" method="post">  
							<input placeholder="Cari Lagi Data Pasien" type="search" value="" name="cari" id="cari" required>
							<input type="submit" value="Cari">
						</form>
						<br/>
						<?php include 'includes/cari_pasien.php'; ?>
                    </div>                      
              </div>
