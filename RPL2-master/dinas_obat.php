                ...
                <div id="templatemo_header_bottom">
                	<div id="templatemo_menu">
                    	<ul>
							...
							<li class="current"><a href="dinas_obat.php"><b>Data Obat</b></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div id="templatemo_content">
            	<div id="templatemo_content_left">
                	<div class="templatemo_post">
						...
						<h1 align="center">Data Obat Yang Sudah Masuk</h1>
						<p>Selamat datang, berikut laporan mengenai data obat yang tercatat dalam sistem : </p> 						 
						<table border="1">
							<thead>
								<tr>
									<th>ID Obat</th>
