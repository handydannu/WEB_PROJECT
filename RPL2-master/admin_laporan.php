                ...
                <div id="templatemo_header_bottom">
                	<div id="templatemo_menu">
                    	<ul>
                            ...
                            <li class="current"><a href="admin_laporan.php"><b>Panel Laporan</b></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                	...
                	<div class="templatemo_post">
						<h1 align="center">Laporan</h1>
							<fieldset style="width : auto%; margin: auto;">
								<legend>Form Laporan</legend>
								
								<form method="post" action="cetaksemuapasien.php">
								<p>Cetak Laporan Semua Pasien</p>
								<input type="submit" value="CETAK DATA PASIEN">
								</form>
								
								<hr color="green" size="3" width="auto">
								
								<form method="post" action="cetaksemuaobat.php">
								<p>Cetak Laporan Semua Data Obat</p>
								<input type="submit" value="CETAK DATA OBAT">
								</form>
							</fieldset>
                    </div>                      
              </div>
