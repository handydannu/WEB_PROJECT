            ...
            <div id="templatemo_content">
            	<div id="templatemo_content_left">
                	<div class="templatemo_post">
						...
						<p>Silahkan login terlebih dahulu untuk mengakses panel perawat. Panel ini dikhususkan untuk Perawat
    						untuk mengelola perihal rekam medis terhadap pasien yang bersangkutan.</p>
                    </div>                      
              </div>
              ...
              <div class="templatemo_section">
                        ...
                        <div class="templatemo_section_1_mid">
                        	<div class="templatemo_form">
                                <form method="post" action="ceklogin_perawat.php">
