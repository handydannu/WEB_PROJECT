            ...
            <div id="templatemo_content">
							...
							<fieldset style="width : auto%; margin: auto;">
								...
								<table border="0">
									...
									<tr><td>ID Penyakit</td><td>:</td><td><input type="text" name="id" value="<?php echo $data['penyakit_id']; ?>" readonly style="background-color: gray;" /></td></tr><tr>	
										<td>Keluhan</td><td>:</td><td><input type="text" maxlength="25" name="penyakit_nama" required /><font color="red">*)</font></td>
									</tr><tr>
              ...
              <div id="templatemo_content_right">
                    ...
                    <div class="templatemo_section">
                        ...
                        <ul>
                        	<li><a href="perawat_rekam.phpid=<?php echo $data['penyakit_id'] ?>">KEMBALI</a> </li>
