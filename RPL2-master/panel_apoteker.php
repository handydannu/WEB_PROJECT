            ...
            <div id="templatemo_content">
            	<div id="templatemo_content_left">
                	<div class="templatemo_post">
						...
						<p>Silahkan login terlebih dahulu untuk mengakses panel apoteker. Panel ini dikhususkan untuk Petugas
						   Apoteker untuk mengelola perihal obat.</p>
                    </div>                      
              </div>
              ...
              <div class="templatemo_section">
                        ...
                        <div class="templatemo_section_1_mid">
                        	<div class="templatemo_form">
                                <form method="post" action="ceklogin_apoteker.php">
