   	  ...
   	  <div class="templatemo_container">
        	...
        	<div id="templatemo_header">
            	<div id="templatemo_logo">
	            	Halaman Depan - Perawat
                </div>
                <div id="templatemo_header_bottom">
                	<div id="templatemo_menu">
                    	<ul>
                        	<li class="current"><a href="perawat_beranda.php"><b>Beranda</b></a></li>
							<li><a href="perawat_rekam.php"><b>Data Rekam Medis</b></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div id="templatemo_content">
            	<div id="templatemo_content_left">
                	<div class="templatemo_post">
                    	<h1>Panel Perawat</h1>
						<p>Selamat datang di panel rekam medic. Gunakan menu yang berkaitan untuk mengakses
